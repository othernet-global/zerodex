...
contract TestDeployment is Deployment
    ...
    function testProperDeployment() public
		...
		assertTrue( daoWithin < 60 * 60 * 24 * 60, "daoVestingWallet start() is too far away!" );
		assertTrue( teamWithin < 60 * 60 * 24 * 60, "teamVestingWallet start() is too far away!" );
		...
		assertTrue( ERC20(address(zero)).decimals() == 18, "ZERO should have 18 decimals" );

        assertEq( getContract(address(exchangeConfig), "zero()"), address(zero), "Incorrect exchangeConfig.zero" );
        ...
        assertEq( getContract(address(airdrop1), "zero()"), address(zero), "Incorrect airdrop1.zero" );

        assertEq( getContract(address(airdrop2), "exchangeConfig()"), address(exchangeConfig), "Incorrect airdrop2.exchangeConfig" );
        assertEq( getContract(address(airdrop2), "zero()"), address(zero), "Incorrect airdrop2.zero" );
		...
		assertEq( getContract(address(stakingRewardsEmitter), "zero()"), address(zero), "Incorrect stakingRewardsEmitter.zero" );
		...
		assertEq( getContract(address(liquidityRewardsEmitter), "zero()"), address(zero), "Incorrect liquidityRewardsEmitter.zero" );

        assertEq( getContract(address(emissions), "zeroRewards()"), address(zeroRewards), "Incorrect emissions.zeroRewards" );
        ...
        assertEq( getContract(address(emissions), "zero()"), address(zero), "Incorrect emissions.zero" );
        ...
        assertEq( getContract(address(upkeep), "zeroRewards()"), address(zeroRewards), "Incorrect upkeep.zeroRewards" );
        ...
        assertEq( getContract(address(upkeep), "zero()"), address(zero), "Incorrect upkeep.zero" );
		...
		assertEq( getContract(address(zeroRewards), "exchangeConfig()"), address(exchangeConfig), "Incorrect zeroRewards.exchangeConfig" );
        assertEq( getContract(address(zeroRewards), "rewardsConfig()"), address(rewardsConfig), "Incorrect zeroRewards.rewardsConfig" );
        assertEq( getContract(address(zeroRewards), "zero()"), address(zero), "Incorrect zeroRewards.zero" );
        assertEq( getContract(address(zeroRewards), "stakingRewardsEmitter()"), address(stakingRewardsEmitter), "Incorrect zeroRewards.stakingRewardsEmitter" );
        assertEq( getContract(address(zeroRewards), "liquidityRewardsEmitter()"), address(liquidityRewardsEmitter), "Incorrect zeroRewards.liquidityRewardsEmitter" );
		...
		assertEq( getContract(address(initialDistribution), "zero()"), address(zero), "Incorrect initialDistribution.zero" );
		...
		assertEq( getContract(address(initialDistribution), "zeroRewards()"), address(zeroRewards), "Incorrect initialDistribution.zeroRewards" );

		assertEq( zero.balanceOf(address(initialDistribution)), 100000000 ether, "The InitialDistribution contract should start with a ZERO balance of 100 million ZERO" );
   	...
   	function testPrint() public view
		...
		console.log( "exchangeConfig: ", address(exchangeConfig) );
   		...
   		console.log( "zero: ", address(zero) );
   		console.log( "zeroRewards: ", address(zeroRewards) );
