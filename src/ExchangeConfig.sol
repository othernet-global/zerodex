...
contract ExchangeConfig is IExchangeConfig, Ownable
	...
	// Gradually distribute ZERO tokens to the teamWallet and DAO over 10 years
	...
	constructor( IZero _zero, IERC20 _wbtc, IERC20 _weth, IERC20 _usdc, IERC20 _usdt, address _teamWallet )
		{
		zero = _zero;
		wbtc = _wbtc;
		weth = _weth;
