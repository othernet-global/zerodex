...
import "../rewards/ZeroRewards.sol";
...
contract Deployment is Test
	...
	IDAO public dao = IDAO(address(0x33fc4e8795a8255671A1FF2Dcbda8d5E07FA02B5));
	...
	IZero public zero = exchangeConfig.zero();
	...
	IZeroRewards public zeroRewards = IZeroRewards(getContract(address(upkeep), "zeroRewards()" ));
	IRewardsEmitter public stakingRewardsEmitter = IRewardsEmitter(getContract(address(zeroRewards), "stakingRewardsEmitter()" ));
	IRewardsEmitter public liquidityRewardsEmitter = IRewardsEmitter(getContract(address(zeroRewards), "liquidityRewardsEmitter()" ));
