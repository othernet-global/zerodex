...
contract TestParametersOffchain is Test
	...
	constructor()
		...
		exchangeConfig = new ExchangeConfig(deployment.zero(), deployment.wbtc(), deployment.weth(), deployment.usdc(), deployment.usdt(), deployment.teamWallet());
	...
	function testStakingParameters() public
		...
		_checkParameter( Parameters.ParameterTypes.modificationCooldown, 15 minutes, 15 minutes, 6 hours, 15 minutes );
		}
	...
	function testRewardsParameters() public
		...
		_checkParameter( Parameters.ParameterTypes.rewardsEmitterDailyPercentTimes1000, 250, 750, 2500, 250 );
	...
	function testDAOParameters() public
		...
		_checkParameter( Parameters.ParameterTypes.baseBallotQuorumPercentTimes1000, 5000, 7000, 20000, 1000 );
